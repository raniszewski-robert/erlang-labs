...
-module(dist).
-export([rand_locs/1, find_closest_parallel/2, find_closest/2]).
...
find_closest_parallel(PeopleLoc, SensorLoc) ->
  _L1 = [spawn(dist,find_for_personPID, [PL, SensorLoc, self()]) || PL <- PeopleLoc],
